    ...
    <div class="container">
        <div class="row justify-content-between gy-5">
            <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
                <h2 data-aos="fade-up">Sağlıklı Olmanın Tadını Çıkarın <br>Lezzetli Yemekler</h2>
                <p data-aos="fade-up" data-aos-delay="100">Sed autem laudantium dolores. Voluptatem itaque ea consequatur eveniet. Eum quas beatae cumque eum quaerat.</p>
                <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                    <a href="<?= base_url() ?>#menu" class="btn-book-a-table">Menuler</a>
                    <a href="https://www.youtube.com/watch?v=dA0VGEbbw4g" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Tanıtım</span></a>
                </div>
            </div>
...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>hakkımızda</h2>
                <p>Hakkımızda <span>Daha Fazla Bilgi Edinin</span></p>
            </div>

            <div class="row gy-4">
                <div class="col-lg-7 position-relative about-img" style="background-image: url(<?= base_url() ?>assets/img/about.jpg) ;" data-aos="fade-up" data-aos-delay="150">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="why-box">
                        <h3>Neden Yummy'yi Seçmelisiniz?</h3>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit
                            Asperiores dolores sed et. Tenetur quia eos. Autem tempore quibusdam vel necessitatibus optio ad corporis.
                        </p>
                        <div class="text-center">
                            <a href="<?= base_url() ?>#" class="more-btn">Daha fazlası<i class="bx bx-chevron-right"></i></a>
                        </div>
                    </div>
                </div><!-- End Why Box -->
    ...
    <section id="menu" class="menu">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>Menüler</h2>
                <p>Nefis<span> Menümüze Göz atın!</span></p>
            </div>
                    ...
                    <div class="row gy-5">
                        ...
                        if (isset($kayitlar) && count($kayitlar) > 0) {
                            ...
                            foreach ($kayitlar as $item) {
                                ...
                                echo '<a class="glightbox"><img class="menu-img img-fluid" src="' . base_url("uploads/") . $item['resim'] . '"/></a>';
                                echo '<h4>' . $item['baslik'] . '</h4>';
                                echo '<p style="text-align:center;">' . word_limiter($item['icerik'], 10) . '</p>';
                                echo '<a href ="' . base_url('incele/' . $item['url']) . '" class ="btn btn-danger">Yemeği İncele</a>';
                                echo '</div>';
                            }
    ...
    <section id="testimonials" class="testimonials section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <p>Hakkımızda<span> nE düşünüyorlar?</span></p>
            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="a<?= base_url() ?>ssets/img/testimonials/testimonials-3.jpg" class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    </div><!-- End testimonial item -->
    ...
    <section id="gallery" class="gallery section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>galeri</h2>
                <p>Galerimize <span>Göz atın</span></p>
            </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-6">
                    <div class="info-item  d-flex align-items-center">
                        ...
                        <div>
                            <h3>Our Address</h3>
                            <p>4000 Sk. Karsıyaka Gonen MYO, BALIKESIR</p>
                        </div>
                    </div>
                </div><!-- End Info Item -->
